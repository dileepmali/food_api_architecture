...
class _AllProductsState extends State<AllProducts> {
  final ChoiceChipController controller = Get.find<ChoiceChipController>();
  final SearchProductController searchProductController = Get.find<SearchProductController>();
